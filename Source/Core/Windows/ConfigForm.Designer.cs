namespace CodeImp.DoomBuilder.Windows
{
    ...
    " one of the categories.";
			...
			this.label14.Location = new System.Drawing.Point(231, 119);
			...
			// tabtesting
			// 
			this.tabtesting.Controls.Add(this.gametype);
			this.tabtesting.Controls.Add(this.label14);
			this.tabtesting.Controls.Add(this.skin);
			...
			this.tabtesting.Controls.Add(this.label8);
			...
			// gametype
			// 
			this.gametype.BackColor = System.Drawing.Color.Transparent;
			this.gametype.Cursor = System.Windows.Forms.Cursors.Default;
			this.gametype.Empty = false;
			this.gametype.GeneralizedCategories = null;
			this.gametype.GeneralizedOptions = null;
			this.gametype.GrayOut = false;
			this.gametype.Location = new System.Drawing.Point(297, 116);
			this.gametype.Name = "gametype";
			this.gametype.Size = new System.Drawing.Size(190, 21);
			this.gametype.TabIndex = 44;
			this.gametype.Value = -1;
			this.gametype.Visible = false;
			this.gametype.ValueChanges += new System.EventHandler(this.gametype_ValueChanges);
			// 
			// skin
			// 
			this.skin.FormattingEnabled = true;
			this.skin.Location = new System.Drawing.Point(87, 116);
			this.skin.Name = "skin";
			this.skin.Size = new System.Drawing.Size(111, 21);
			this.skin.TabIndex = 42;
			this.skin.Visible = false;
			this.skin.SelectedIndexChanged += new System.EventHandler(this.skin_SelectedIndexChanged);
			// 
			// btnRemoveEngine
			// 
			...
			this.skill.GrayOut = true;
			this.skill.Location = new System.Drawing.Point(85, 116);
        ...
        private CodeImp.DoomBuilder.Controls.ActionSelectorControl gametype;
